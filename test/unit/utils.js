  ...
  describe('parse', () => {
    describe('date', () => {
      it('returns null for invalid dates', () => {
        ...
        expect(ParsleyUtils.parse.date('1972/01/06')).to.be.null;
        expect(ParsleyUtils.parse.date('1972-01-6')).to.be.null;
        expect(ParsleyUtils.parse.date('1972-1-06')).to.be.null;
        expect(ParsleyUtils.parse.date('  1972-01 -06  ')).to.be.null;
      });
